...
public class Graph implements GraphInterface, OnChartValueSelectedListener
    {
        ...
        public LineChart create_chart(View context)
        ...
        @Override public void addDataSet(String label, ArrayList<Entry> dataSet)
            {//ajouter les entry dans le tableau
                //TODO : ajouter les anticon --> verif sur le label/ entry vide
                if (dataSets.size() == max_curve)
                    { //on ne veux pas plus de 4 courbes dans notre appli
        ...
        @Override public void removeDataSet(String label)
            { //clear le tablea I gess, de une seule courbe
        ...
        @Override public void show()
            { // affiche toute les courbes et le graph
        ...
        @Override public void showDataSet(String label)
            {//affiche une des courbes graphique et desaffiche les autres
                ArrayList<ILineDataSet> dataSe = new ArrayList<>();
                for (int i = 0; i < dataSets.size(); i++)
                    {
                        if (dataSets.get(i).getLabel() == label)
        ...
        @Override public void rename(String newLabel)
            { //renomer dans la listes des grphique??
        ...
        @Override public String print()
            { // affiche dans la console, toute les courbes
                String out = "";
